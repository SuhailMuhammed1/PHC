...
import 'dart:convert';
class vw_noti_pt extends StatefulWidget {
  const vw_noti_pt({Key? key}) : super(key: key);

  @override
  State<vw_noti_pt> createState() => _vw_noti_ptState();
}

class _vw_noti_ptState extends State<vw_noti_pt> {

  late List data;
  void List_function() async {
    var url = Uri.parse(login.url+"notification/vwntpt/");
