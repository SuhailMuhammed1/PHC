...
import 'dart:convert';
class vw_noti_dr extends StatefulWidget {
  const vw_noti_dr({Key? key}) : super(key: key);

  @override
  State<vw_noti_dr> createState() => _vw_noti_drState();
}

class _vw_noti_drState extends State<vw_noti_dr> {

  late List data;
  void List_function() async {
    var url = Uri.parse(login.url+"notification/vntdr/");
