...
import 'dart:convert';
class vw_noti_jhi extends StatefulWidget {
  const vw_noti_jhi({Key? key}) : super(key: key);

  @override
  State<vw_noti_jhi> createState() => _vw_noti_jhiState();
}

class _vw_noti_jhiState extends State<vw_noti_jhi> {

  late List data;
  void List_function() async {
    var url = Uri.parse(login.url+"notification/vwntjhi/");
